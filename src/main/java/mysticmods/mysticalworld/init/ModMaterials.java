...
public class ModMaterials {
  ...
  public static MaterialType CARAPACE = new MaterialType(CARAPACE_NAME).item(() -> ModItems.CARAPACE).itemMaterial(399, 4.0f, 1.0f, 2, 18).armorMaterial(7, new int[]{3, 0, 0, 0}, SoundEvents.ITEM_ARMOR_EQUIP_TURTLE, 1.0f, 0f).setConfigProvider(ConfigManager::getArmorConfig);

  public static MaterialType AMETHYST = new MaterialType(AMETHYST_NAME).itemMaterial(960, 8.0f, 3.0f, 3, 14, () -> MWTags.Items.AMETHYST_GEM).item(() -> ModItems.AMETHYST_GEM).block(() -> ModBlocks.AMETHYST_BLOCK).ore(() -> ModBlocks.AMETHYST_ORE).armorMaterial(33, new int[]{3, 6, 8, 3}, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0f, 0f).setMinXP(1).setMaxXP(4).setModId(MysticalWorld.MODID).putDamageSpeed(
      WeaponType.AXE, 6.0f, -3.1f,
      WeaponType.KNIFE, 0.5f, -1.5f).setConfigProvider(ConfigManager::getArmorConfig);

  public static MaterialType COPPER = new MaterialType(COPPER_NAME).itemMaterial(200, 4.0f, 2.0f, 2, 7, () -> MWTags.Items.COPPER_INGOT).item(() -> ModItems.COPPER_INGOT).nugget(() -> ModItems.COPPER_NUGGET).dust(() -> ModItems.COPPER_DUST).block(() -> ModBlocks.COPPER_BLOCK).ore(() -> ModBlocks.COPPER_ORE).armorMaterial(15, new int[]{2, 5, 6, 2}, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0f).setModId(MysticalWorld.MODID).putDamageSpeed(
  ...
  public static MaterialType QUICKSILVER = new MaterialType(QUICKSILVER_NAME).itemMaterial(75, 6.0f, 2.5f, 3, 22, () -> MWTags.Items.QUICKSILVER_INGOT).item(() -> ModItems.QUICKSILVER_INGOT).nugget(() -> ModItems.QUICKSILVER_NUGGET).dust(() -> ModItems.QUICKSILVER_DUST).block(() -> ModBlocks.QUICKSILVER_BLOCK).ore(() -> ModBlocks.QUICKSILVER_ORE).armorMaterial(7, new int[]{1, 3, 5, 2}, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0f, 0f).setModId(MysticalWorld.MODID).putDamageSpeed(
      WeaponType.AXE, 6.0f, -2.6f,
      WeaponType.KNIFE, 0.5f, -1.0f).setConfigProvider(ConfigManager::getArmorConfig);

  public static MaterialType SILVER = new MaterialType(SILVER_NAME).itemMaterial(175, 6.0f, 2.5f, 2, 22, () -> MWTags.Items.SILVER_INGOT).item(() -> ModItems.SILVER_INGOT).nugget(() -> ModItems.SILVER_NUGGET).dust(() -> ModItems.SILVER_DUST).block(() -> ModBlocks.SILVER_BLOCK).ore(() -> ModBlocks.SILVER_ORE).setModId(MysticalWorld.MODID).armorMaterial(7, new int[]{1, 3, 5, 2}, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0f, 0f).putDamageSpeed(
      WeaponType.AXE, 6.0f, -3.1f,
      WeaponType.KNIFE, 0.5f, -1.0f).setConfigProvider(ConfigManager::getArmorConfig);

  public static MaterialType TIN = new MaterialType(TIN_NAME).itemMaterial(165, 6.5f, 2.0f, 2, 7, () -> MWTags.Items.TIN_INGOT).item(() -> ModItems.TIN_INGOT).nugget(() -> ModItems.TIN_NUGGET).dust(() -> ModItems.TIN_DUST).block(() -> ModBlocks.TIN_BLOCK).ore(() -> ModBlocks.TIN_ORE).armorMaterial(10, new int[]{1, 4, 5, 2}, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0f).setModId(MysticalWorld.MODID).putDamageSpeed(
      WeaponType.AXE, 6.0f, -2.7f,
      WeaponType.KNIFE, 0f, -1.2f).setConfigProvider(ConfigManager::getArmorConfig);

  public static MaterialType CACTUS = new MaterialType(CACTUS_NAME).itemMaterial(76, 4.0f, 1.5f, 1, 3, new LazyIngredient(() -> Ingredient.fromItems(Blocks.CACTUS))).setArmorMaterial(ArmorMaterial.LEATHER /* Not actually used as there is no cactus armor */).setModId(MysticalWorld.MODID).putDamageSpeed(
