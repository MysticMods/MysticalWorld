...
public class ModMaterials {
  ...
  public static MaterialType CARAPACE = new MaterialType(CARAPACE_NAME).item(() -> ModItems.CARAPACE).itemMaterial(512, 4.0f, 1.0f, 2, 18, () -> MWTags.Items.CARAPACE).armorMaterial(7, new int[]{2, 5, 6, 2}, SoundEvents.ARMOR_EQUIP_TURTLE, 1.0f, 0f).setConfigProvider(ConfigManager::getArmorConfig);
