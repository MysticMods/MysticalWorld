...
public class ModLang {
  static {
    MysticalWorld.REGISTRATE.addDataGenerator(ProviderType.LANG, (p) -> {
      ...
      p.add("mysticalworld.subtitles.entity.fennec.aggro", "Fennec yips");
      p.add("mysticalworld.subtitles.entity.fennec.bark", "Fennec barks");
      p.add("mysticalworld.subtitles.entity.fennec.bite", "Fennec bites");
      p.add("mysticalworld.subtitles.entity.fennec.death", "Fennec dies");
      p.add("mysticalworld.subtitles.entity.fennec.eat", "Fennec eats");
      p.add("mysticalworld.subtitles.entity.fennec.idle", "Fennec yips");
      p.add("mysticalworld.subtitles.entity.fennec.sleep", "Fennec sleeps");
      p.add("mysticalworld.subtitles.entity.fennec.sniff", "Fennec sniffs");
      p.add("mysticalworld.subtitles.entity.fennec.spit", "Fennec spits");
