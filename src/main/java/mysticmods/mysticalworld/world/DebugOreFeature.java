...
public class DebugOreFeature extends OreFeature {
  public DebugOreFeature(Codec<OreConfiguration> p_66531_) {
    super(p_66531_);
  }
  ...
  protected boolean doPlace(WorldGenLevel pLevel, Random pRandom, OreConfiguration pConfig, double pMinX, double pMaxX, double pMinZ, double pMaxZ, double pMinY, double pMaxY, int pX, int pY, int pZ, int pWidth, int pHeight) {
    int i = 0;
