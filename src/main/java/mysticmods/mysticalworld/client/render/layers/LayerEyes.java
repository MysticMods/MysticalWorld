...
public class LayerEyes<T extends LavaCatEntity> extends EyesLayer<T, LavaCatModel<T>> {
	private static final RenderType LAVA_EYES = RenderType.eyes(new ResourceLocation(MysticalWorld.MODID, "textures/entity/magma_cat_eyes.png"));
	private static final RenderType OBSIDIAN_EYES = RenderType.eyes(new ResourceLocation(MysticalWorld.MODID, "textures/entity/magma_cat_obsidian_eyes.png"));
