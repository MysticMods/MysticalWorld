          ...
          LootTable.lootTable()
              ...
              .withPool(
                  LootPool.lootPool()
                      ...
                      .add(LootItem.lootTableItem(ModItems.SILK_COCOON.get()).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 7.0f))))
                      .add(LootItem.lootTableItem(ModItems.SPINDLE.get()).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 7.0f))))
          ...
          LootTable.lootTable()
              .withPool(
                  LootPool.lootPool()
                      ...
                      .add(LootItem.lootTableItem(Items.PUMPKIN_SEEDS).setWeight(20).apply(SetItemCountFunction.setCount(UniformGenerator.between(10, 20))))
                      .add(LootItem.lootTableItem(Items.LILY_PAD).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(10, 20))))
                      .add(LootItem.lootTableItem(Items.RABBIT_FOOT).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 6))))
              )
              .withPool(
                  LootPool.lootPool()
                      .setRolls(UniformGenerator.between(1, 3))
          ...
          LootTable.lootTable()
              .withPool(
                  LootPool.lootPool()
                      ...
                      .add(LootItem.lootTableItem(Items.SEA_PICKLE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(3f, 10f))))
                      .add(LootItem.lootTableItem(Items.WHEAT).setWeight(12).apply(SetItemCountFunction.setCount(UniformGenerator.between(5f, 25f))))
                  ...
                  LootPool.lootPool()
                      ...
                      .setBonusRolls(UniformGenerator.between(1f, 3f))
                      .add(LootItem.lootTableItem(Items.GLOWSTONE_DUST).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(6f, 12f))))
                      .add(LootItem.lootTableItem(Items.REDSTONE).setWeight(25).apply(SetItemCountFunction.setCount(UniformGenerator.between(4f, 18f))))
                      .add(LootItem.lootTableItem(Items.SUGAR).setWeight(30).apply(SetItemCountFunction.setCount(UniformGenerator.between(10f, 35f))))
                      .add(LootItem.lootTableItem(Items.NETHER_WART).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1f, 4f))))
                      .add(LootItem.lootTableItem(Items.GUNPOWDER).setWeight(15).apply(SetItemCountFunction.setCount(UniformGenerator.between(8f, 20f))))
                      .add(LootItem.lootTableItem(Items.BLAZE_POWDER).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2f, 8f))))
              ).withPool(
                  LootPool.lootPool()
                      .setRolls(UniformGenerator.between(0, 1))
