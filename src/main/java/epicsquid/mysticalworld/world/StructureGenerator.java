...
//
//		if (world.getDimension().getType() != DimensionType.field_223227_a_) return;
...
//
//		ServerChunkProvider serverProvider = ((ServerWorld) world).getChunkProvider();
...
//
//		IChunk chunk = world.getChunk(zxPos);
...
////			if (s.equals("spawner")) {
////				if (world.setBlockState(blockPos, Blocks.SPAWNER.getDefaultState(), 16)) {
