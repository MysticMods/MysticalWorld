...
public class ModBlocks {
  ...
  public static RegistryEntry<GallAppleCropBlock> GALL_APPLE_CROP = REGISTRATE.block("gall_apple_crop", Material.PLANTS, GallAppleCropBlock::new)
      ...
      .loot((p, t) -> p.registerLootTable(
          ModBlocks.GALL_APPLE_CROP.get(), LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(ModItems.GALL_APPLE.get()).acceptFunction(SetCount.builder(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(ModBlocks.GALL_APPLE_CROP.get()).with(GallAppleCropBlock.AGE, 3))).acceptFunction(SetCount.builder(ConstantRange.of(0)).acceptCondition(BlockStateProperty.builder(ModBlocks.GALL_APPLE_CROP.get()).with(GallAppleCropBlock.AGE, 2)).acceptCondition(BlockStateProperty.builder(ModBlocks.GALL_APPLE_CROP.get()).with(GallAppleCropBlock.AGE, 1)).acceptCondition(BlockStateProperty.builder(ModBlocks.GALL_APPLE_CROP.get()).with(GallAppleCropBlock.AGE, 0)))))))
      .blockstate(NonNullBiConsumer.noop())
      .register();
