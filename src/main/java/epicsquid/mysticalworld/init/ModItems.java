...
public class ModItems {
  ...
  public static void registerItems(@Nonnull RegisterContentEvent event) {
    ...
    MaterialTypes.addMaterial("mysticalworld:copper", copper, 0.5f, -1.5f);
    MaterialTypes.addMaterial("mysticalworld:silver", silver, 0.5f, -1.0f);
    MaterialTypes.addMaterial("mysticalworld:amethyst", amethyst, 1f, -1.0f);
