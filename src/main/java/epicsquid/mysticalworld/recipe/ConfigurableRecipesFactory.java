...
public class ConfigurableRecipesFactory implements IConditionFactory {
  ...
  public BooleanSupplier parse(JsonContext context, JsonObject json) {
    ...
    switch (key) {
      ...
      case "copper_armor":
        return () -> ConfigManager.armorEnable.enableCopper;
      case "silver_armor":
        return () -> ConfigManager.armorEnable.enableSilver;
