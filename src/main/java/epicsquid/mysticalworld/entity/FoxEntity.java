...
public class FoxEntity extends TameableEntity {
  private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.createKey(FoxEntity.class, DataSerializers.FLOAT);
  private static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(FoxEntity.class, DataSerializers.BOOLEAN);
...
//	}
  ...
  public boolean shouldAttackEntity(LivingEntity target, LivingEntity owner) {
    if (!(target instanceof CreeperEntity) && !(target instanceof GhastEntity)) {
      if (target instanceof FoxEntity) {
        FoxEntity entityfox = (FoxEntity) target;
  ...
  public static class SleepGoal extends Goal {
    ...
    public SleepGoal(FoxEntity entityIn) {
