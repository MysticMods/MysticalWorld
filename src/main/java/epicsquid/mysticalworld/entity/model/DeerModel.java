...
public class DeerModel extends AgeableModel<DeerEntity> {
  ...
  public DeerModel() {
    ...
    legLF.addCuboid(-1F, 0F, -1F, 2, 9, 2);
    ...
    horn2.addCuboid(-0.5F, -5F, -0.5F, 1, 5, 1);
    ...
    horn3.addCuboid(-0.5F, -5F, -0.5F, 1, 5, 1);
    ...
    horn4.addCuboid(-0.5F, -5F, -0.5F, 1, 5, 1);
    ...
    horn5.addCuboid(-0.5F, -5F, -0.5F, 1, 5, 1);
    ...
    horn6.addCuboid(-0.5F, -5F, -0.5F, 1, 5, 1);
    ...
    horn7.addCuboid(-0.5F, -3F, -0.5F, 1, 3, 1);
    ...
    horn8.addCuboid(-0.5F, -3F, -0.5F, 1, 3, 1);
  ...
  @Override
  public void setAngles(DeerEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
