...
public class BeetleModel extends AgeableModel<BeetleEntity> {
  ...
  public BeetleModel() {
    ...
    this.legL2.addCuboid(-0.5F, 0.0F, -0.5F, 1, 7, 1, 0.0F);
    ...
    this.antennaL1.addCuboid(-0.5F, -5.0F, -0.5F, 1, 5, 1, 0.0F);
    ...
    this.wingL.addCuboid(-2.5F, 0.0F, -1.0F, 5, 8, 3, 0.0F);
    ...
    this.wingR.addCuboid(-2.5F, 0.0F, -1.0F, 5, 8, 3, 0.0F);
    ...
    this.legR1.addCuboid(-0.5F, 0.0F, -0.5F, 1, 7, 1, 0.0F);
    ...
    this.body.addCuboid(-2.5F, -2.0F, 0.0F, 5, 4, 8, 0.0F);
    this.antennaR1 = new ModelRenderer(this, 24, 6);
    this.antennaR1.setRotationPoint(-1.0F, 0.0F, -0.5F);
    this.antennaR1.addCuboid(-0.5F, -5.0F, -0.5F, 1, 5, 1, 0.0F);
    ...
    this.antennaR2.addCuboid(-0.5F, -5.0F, -0.5F, 1, 5, 1, 0.0F);
    ...
    this.legL1.addCuboid(-0.5F, 0.0F, -0.5F, 1, 7, 1, 0.0F);
    ...
    this.legL3.addCuboid(-0.5F, 0.0F, -0.5F, 1, 7, 1, 0.0F);
    ...
    this.legR3.addCuboid(-0.5F, 0.0F, -0.5F, 1, 7, 1, 0.0F);
    ...
    this.antennaR2_1.addCuboid(-0.5F, -5.0F, -0.5F, 1, 5, 1, 0.0F);
  ...
  @Override
  public void setAngles(BeetleEntity beetleEntity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
