...
public class SpiritDeerModel extends GlowingModel<SpiritDeerEntity> {
  ...
  @Override
  public void setRotationAngles(SpiritDeerEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
