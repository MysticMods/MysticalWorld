...
public class FrogModel extends AgeableModel<FrogEntity> {
  ...
  public FrogModel() {
    ...
    this.head.addCuboid(-1.5F, -1.0F, -3.0F, 3, 2, 3, 0.0F);
    ...
    this.backL.addCuboid(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
    ...
    this.frontL.addCuboid(-0.5F, 0.0F, -0.5F, 1, 4, 1, 0.0F);
    this.setRotateAngle(frontL, 0.2617993877991494F, 0.0F, -0.2617993877991494F);
    this.body = new ModelRenderer(this, 0, 9);
    this.body.setRotationPoint(0.0F, 22.0F, 0.0F);
    this.body.addCuboid(-1.5F, -1.0F, -3.0F, 3, 2, 5, 0.0F);
    ...
    this.backR.addCuboid(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
    ...
    this.frontR.addCuboid(-0.5F, 0.0F, -0.5F, 1, 4, 1, 0.0F);
