...
public class WitchHeadModel extends GenericHeadModel {
  ...
  public WitchHeadModel() {
    ...
    this.villagerHead.setTextureOffset(0, 0).addCuboid(-4.0F, -10.0F, -4.0F, 8, 10, 8, 0);
    ...
    this.villagerNose.setTextureOffset(24, 0).addCuboid(-1.0F, -1.0F, -6.0F, 2, 4, 2, 0);
    this.villagerHead.addChild(this.villagerNose);
    ModelRenderer mole = (new ModelRenderer(this)).setTextureSize(64, 128);
    mole.setRotationPoint(0.0F, -2.0F, 0.0F);
    mole.setTextureOffset(0, 0).addCuboid(0.0F, 3.0F, -6.75F, 1, 1, 1, -0.25F);
    this.villagerNose.addChild(mole);
    this.unknown = (new ModelRenderer(this)).setTextureSize(64, 128);
    this.unknown.setRotationPoint(-5.0F, -10.03125F, -5.0F);
    this.unknown.setTextureOffset(0, 64).addCuboid(0.0F, 0.0F, 0.0F, 10, 2, 10);
    ...
    renderermodel.setTextureOffset(0, 76).addCuboid(0.0F, 0.0F, 0.0F, 7, 4, 7);
    ...
    renderermodel1.setTextureOffset(0, 87).addCuboid(0.0F, 0.0F, 0.0F, 4, 4, 4);
    ...
    renderermodel2.setTextureOffset(0, 95).addCuboid(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.25F);
